...
| Действие | Лимит | Окно | Тюнинг через env |
|---|---|---|---|
| Лайк    | 30   | 60 сек  | `RATE_LIMIT_LIKES`   / `RATE_LIMIT_LIKES_WINDOW` |
| Жалоба  | 5    | 300 сек | `RATE_LIMIT_REPORTS` / `RATE_LIMIT_REPORTS_WINDOW` |
